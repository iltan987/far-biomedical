...
type CTAOptions = VariantProps<typeof ctaVariants> & {
  className?: string;
};
...
type CtaAnchorProps = Omit<React.ComponentProps<"a">, "className"> & CTAOptions;

type CtaButtonProps = Omit<React.ComponentProps<"button">, "className"> &
  CTAOptions;
